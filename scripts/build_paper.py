#!/usr/bin/env python3
"""Build the grounded-hypercalculi research paper PDF from LaTeX source.

Compiles paper/grounded_hypercalculi.tex into paper/grounded_hypercalculi.pdf.
...
PAPER = ROOT / "paper"
TEX_FILE = "grounded_hypercalculi.tex"
PDF_FILE = "grounded_hypercalculi.pdf"
